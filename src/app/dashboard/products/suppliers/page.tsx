...
export default async function SuppliersPage({ searchParams }: SuppliersPageProps) {
  ...
  const where: Prisma.SupplierWhereInput = searchParams.search
    ? {
        OR: [
  ...
  const orderBy: Prisma.SupplierOrderByWithRelationInput = searchParams.sortBy
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {suppliers.map((supplier) => (
              <tr key={supplier.id}>
                ...
                <td className="whitespace-nowrap px-6 py-4">
                  <div className="text-sm text-gray-900">{supplier._count.products}</div>
                </td>
                <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                  <Link
                    href={`/dashboard/products/suppliers/${supplier.id}/edit`}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
          <div className="flex flex-1 justify-between sm:hidden">
            <Link
              href={`/dashboard/products/suppliers?page=${page - 1}`}
